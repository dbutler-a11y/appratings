  ...
  return (
    <div className="flex flex-wrap gap-3">
      {links.map((link) => {
        ...
        const href = link.affiliateUrl || link.url;
        ...
        return (
          <a
            ...
            className={`inline-flex items-center gap-2 px-4 py-2.5 rounded-lg text-white font-medium transition-colors ${config.bgClass}`}
          >
            {config.icon}
            <span>{label}</span>
          </a>
